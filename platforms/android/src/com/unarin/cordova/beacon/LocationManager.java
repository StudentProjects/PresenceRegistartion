...
public class LocationManager extends CordovaPlugin implements BeaconConsumer {
    ...
    private void initBeaconTransmitter() {
    ...
    private void isAdvertisingAvailable(CallbackContext callbackContext) {
        ...
        _handleCallSafely(callbackContext, new ILocationManagerCommand() {
            ...
            public PluginResult run() {
                ...
                boolean isAvailable = (BeaconTransmitter.checkTransmissionSupported(getApplicationContext()) == BeaconTransmitter.SUPPORTED);

                PluginResult result = new PluginResult(PluginResult.Status.OK, isAvailable);
                result.setKeepCallback(true);
                return result;
    ...
    private void isAdvertising(CallbackContext callbackContext) {
        ...
        _handleCallSafely(callbackContext, new ILocationManagerCommand() {
            ...
            public PluginResult run() {
                ...
                boolean isAdv = beaconTransmitter.isStarted();

                PluginResult result = new PluginResult(PluginResult.Status.OK, isAdv);
                result.setKeepCallback(true);
                return result;
            ...
            public PluginResult run() {
                ...
                try {
                    ...
                    Beacon beacon = new Beacon.Builder()
                            ...
                            .setManufacturer(224) //google's ID
                            .setRssi(-73)
                            .setTxPower(-73)
                    ...
                    PluginResult result = new PluginResult(PluginResult.Status.OK, "iBeacon Advertising started");
                    result.setKeepCallback(true);
                    return result;
                }
                catch (Exception e){
                    debugWarn("'startAdvertising' exception " + e.getMessage());
                    return new PluginResult(PluginResult.Status.ERROR, "'startAdvertising' exception " + e.getMessage());
                }
            }
        });
    }
        ...
        _handleCallSafely(callbackContext, new ILocationManagerCommand() {
            ...
            public PluginResult run() {
                ...
                try {
                    ...
                    debugWarn("'stopAdvertising' exception " + e.getMessage());
                    return new PluginResult(PluginResult.Status.ERROR, e.getMessage());
                }
            }
        });
